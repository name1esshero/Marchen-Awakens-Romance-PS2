...
| P1 | Recover CCamera/CCamera2/CCameraMv class evidence | Partial layout candidates for 3 classes now exist ([LINKONCE_CLUSTER.md](tasks/LINKONCE_CLUSTER.md)); `GetViewRect`, view/projection matrix pairs and all `__tf*` type-info accessors in this cluster still open | Justified layout/signatures plus authentic-source review and complete ELF comparison |
