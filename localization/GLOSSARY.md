# Localization glossary (draft)

These terms keep the current English message-table draft consistent. They are
not claims about an official English release; verify names, combat terminology,
and layout in game before treating them as final.
...
| 小攻撃 / 大攻撃 | light attack / heavy attack | Descriptive move labels; verify against in-game move names. |
| コンビネーション攻撃 | combo | Short UI term for chained attacks. |
| オートガード / マニュアルガード | auto-guard / manual guard | Preserve distinction in tutorial text. |
| 属性 | element | Current labels: Neutral, Wind, Earth, Water, Fire, Thunder, Wood. |
| ゲート / 修練の門 | Gate of Training | Provisional rendering of the training facility. |
| 固有ARM names | Babbo, Gargoyle, Toto, Ice Dearth, Andata, Allumage, etc. | Provisional romanizations/translations based on the source strings; check authoritative in-game spellings before final release. |
